...
import { Home, ArrowLeftRight, Trophy, Users, Plus } from "lucide-react"
...
const TABS = [
  ...
  { value: "podium", label: "Podium", icon: Trophy, href: "/?tab=podium" },
...
function BottomBarNav() {
  ...
  // On home, `?tab=` is the active tab. Everywhere else (a post, a betting pool, a
