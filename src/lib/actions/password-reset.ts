...
export async function requestPasswordReset(
  ...
  // Same Server-Action reachability as signUp — a 307'd form POST re-runs the action.
  // Returns the usual success shape: this endpoint never reveals whether an account
  // exists, and a downtime-specific answer would be exactly that oracle.
  if ((await downtimeState()).down) return { success: true }
