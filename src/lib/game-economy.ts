 ...
 *  and at E[payout] = 1.5 ZP (see ZP_BY_TICKS) it is a deliberately bad one: a replay
 *  loses 0.5 ZP on average. It used to be +EV, which is exactly why one account ran
 *  645,507 automated spins in a single term. The cost is now a real limiter. */
