...
// This file's exports must track the real bomb-axa.tsx's public API.
//
...
export function BombAxa({ index = 0 }: { index?: number }) {
  return (
    <GameCard
      icon={Bomb}
      name="Bomb AXA"
      hint="This game isn't publicly available."
      ariaLabel="Bomb AXA — this game isn't publicly available."
      index={index}
      disabled
      onClick={() => {}}
    />
